...
L.TileLayer.Bing = L.TileLayer.extend({
    ...
    attributionTemplate: '<span>{copyrights}' +
       ...
       'Terms of Use</a></span>' +
       '<span id="bing-logo" style="float:right;margin-left:3px;"><a target="_blank" href="http://www.bing.com/maps/">' +
       '<img src="{logo}" height="15" /></a></span>',
            ...
            if (this.options.opacity > 0) {
                ...
                for (i = 0, ii = providers.length; i < ii; ++i) {
                    ...
                    for (j = 0, jj = provider.coverageAreas.length; j < jj; ++j) {
                        ...
                        if (zoom <= coverage.zoomMax && zoom >= coverage.zoomMin && coverage.bbox.contains(bounds)) {
